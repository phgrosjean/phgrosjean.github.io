...
- **Static pages**: you can go very far with static pages generated with [Jekyll](https://jekyllrb.com) or [Hugo](https://gohugo.io), and you get also full reproductible production including data analysis using [Bookdown](https://bookdown.org/yihui/bookdown/) or [Blogdown](https://bookdown.org/yihui/blogdown/).
